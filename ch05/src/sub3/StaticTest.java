 ...
 * 날짜 : 2025/07/14
 * 이름 : 우지희
 * 내용 : Static 변수(클래스 변수), Static 메서드(클래스 메서드) 실솝하기
 * 
 * 클래스변수(정적변수), 클래스 메서도(정적메서드)
...
public class StaticTest {
	public static void main(String[] args) {
		...
		System.out.println("전체 차량수 : " + Car.getCount());//sonata.getCount()로 안한다는 소리
